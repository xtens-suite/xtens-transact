        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(ids) {
                ...
                return BluebirdPromise.map(dataType.parents, function(idParent) {
                    ...
                    }).into('datatype_parents__datatype_children').transacting(trx);
                });
            });
    ...
    updateDataType: function(dataType) {
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(idUpdated) {
                return knex.select('*').from('datatype_parents__datatype_children').transacting(trx);
            })
            ...
            .then(function(foundDTAssociations) {
                ...
                return BluebirdPromise.map(dataType.parents, function(idParent) {
                    ...
                    if (_.findWhere({'datatype_children': idParent, 'datatype_parent': dataType.id})) {
                        return;
                    }
