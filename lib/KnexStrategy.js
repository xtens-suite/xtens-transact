...
KnexStrategy.prototype = {
     ...
     */
    handleFiles: function(idData, files, trx) {
    ...
    createData: function(data, dataTypeName) {
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(ids) {
                ...
                return that.handleFiles(idData, files, trx);
    ...
    createSample: function(sample, sampleTypeName) {
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(maxBiobankCode) {
                ...
                var sampleCode = sample.biobankCode || nextCode || '080001';          
                return knex.returning('id').insert({
     ...
     *
     */
    putMetadataFieldsIntoEAV: function(idDataType, fields, useFormattedNames) {
    ...
    putMetadataValuesIntoEAV: function(data, eavValueTableMap) {
        ...
        return knex.transaction(function(trx) {
            ...
            .then(function(row) {
                ...
                var entityTable = row.model.toLowerCase().toUnderscore(); 
